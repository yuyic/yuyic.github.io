function SpaceWarpFilter() {
  PIXI.Filter.call(this,
      ...
      `
        ...
        uniform float mouseY;
    		...
    		#define mouse vec2(sin(mouseX), cos(mouseY))
 ...
 float time2 = time;
       ...
       vec3 from=vec3(0.0, 0.0,0.0);
        ...
        backCol2.bg = mix(backCol2.gb, backCol2.bg, 0.5*(1.5));
...
SpaceWarpFilter.prototype = Object.create(PIXI.Filter.prototype);
SpaceWarpFilter.prototype.constructor = SpaceWarpFilter;
